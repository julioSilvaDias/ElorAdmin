...
<head>
    ...
    <title>Inicio - CIPF Elorrieta Errekamari</title>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center my-5">
                    <div class="col-md-8 text-center">
                        <h1 class="display-4 text-primary">¡Bienvenido a Elorrieta-Errekamari Alumno!</h1>
                    </div>
                </div>
                <!-- Ciclos matriculados -->
                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse{{ $cicloUsuario->id }}" aria-expanded="true" aria-controls="collapseOne">
